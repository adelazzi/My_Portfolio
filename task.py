...
modules = ['loading','mainpage','home','about','contact','education','experiance','projects','skills']
...
import 'package:my_portfolio/app/modules/{module}/controllers/{module}_controller.dart';
...
def update_app_pages(modules):
    ...
    for module in modules:
        ...
        import_section += f"import 'package:my_portfolio/app/modules/{module}/bindings/{module}_binding.dart';\n"
        import_section += f"import 'package:my_portfolio/app/modules/{module}/views/{module}_view.dart';\n"
